...
def display_message():
    print("I'm learning about python functions!")
...
def make_shirt(size: str = 'large', message: str = 'I love Fate.'):
    print(f"The shirt will be {size} in size with \"{message}\" as a message")

make_shirt("small","Lo and behold!")
make_shirt(size = "medium", message = "The almighty Gilgamesh!")
...
print(city_country('Venice','Italy'))
print(city_country('Fuyuki','Japan'))
...
print(make_album('Skillet','Rise'))
print(make_album('Poor Mans Poison',"Hell's Coming with Me"))
print(make_album('Ado','OP:Red'))
print(make_album('Vickeblanka','Devil'))
...
def make_car(manufacturer ,model_name , **kwargs) -> dict:
    dictionary = {'manufacturer':manufacturer,'model name':model_name}
    if kwargs:
